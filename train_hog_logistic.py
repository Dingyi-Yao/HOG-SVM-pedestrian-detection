...
def train():
    ...
    #设置SVM分类器
    logistic_classifier = LogisticRegression(C=0.001,max_iter=1000,class_weight='balanced')
    logistic_classifier.fit(feature_list, label)
    #保存分类器
    joblib.dump(logistic_classifier, 'logistic_classifier_0.001.pkl')
